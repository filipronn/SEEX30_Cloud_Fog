...
# Global vars
BASE_PATH_DATA = 'cot_train/data/synthetic-cot-data'
BASE_PATH_LOG = 'cot_train/log'
USE_GPU = False  # The code uses small-scale models, GPU doesn't seem to accelerate things actually
SEED = 0
SPLIT_TO_USE = 'test'  # 'train', 'val' or 'test'
BATCH_SIZE = 32
...
#
MODEL_LOAD_PATH = ['cot_train/log/2024-03-11_12-44-40/model_it_2000000']
...
MODEL_LOAD_PATH = ['smhi_models/2023-08-10_10-33-44/model_it_2000000', 'smhi_models/2023-08-10_10-34-06/model_it_2000000', 'smhi_models/2023-08-10_10-34-18/model_it_2000000',
				   'smhi_models/2023-08-10_10-34-28/model_it_2000000', 'smhi_models/2023-08-10_10-34-46/model_it_2000000', 'smhi_models/2023-08-10_10-34-58/model_it_2000000',
				   'smhi_models/2023-08-10_10-35-09/model_it_2000000', 'smhi_models/2023-08-10_10-35-31/model_it_2000000', 'smhi_models/2023-08-10_10-35-52/model_it_2000000',
				   'smhi_models/2023-08-10_10-36-12/model_it_2000000']
...
copyfile("cot_train/cot_synth_eval.py", os.path.join(log_dir, "cot_synth_eval.py"))
...
trainset=np.load('synthetic-cot-data_prev/synthetic-cot-data/trainset_smhi.npy')
valset=np.load('synthetic-cot-data_prev/synthetic-cot-data/valset_smhi.npy')
testset=np.load('synthetic-cot-data_prev/synthetic-cot-data/testset_smhi.npy')
...
for model_load_path in MODEL_LOAD_PATH:  # Ensemble approach if len(MODEL_LOAD_PATH) > 1
	...
	model.eval()
	models.append(model)
criterion = nn.MSELoss().to(device)  # NB: L1Loss used in eval to get RMSE instead (no backprop, just eval)
...
for noise_idx, noise in enumerate(INPUT_NOISE):
	...
	while True:
		...
		for model in models:
			...
			preds += curr_pred
		loss = torch.sqrt(criterion(preds[:, 0]*gt_max, curr_gts*gt_max))
